...
def ex3():
	...
	alpha = 1e-2
	max_iter = 10000
	res = fit_(x, y, theta, alpha, max_iter)
	print(res) # Output: array([[ 7.111..],[ 1.0],[-2.888..],[ 2.222..]])
	...
	max_iter = 42000
	res = fit_(x, y, theta, alpha, max_iter)
	print(res) # Output: array([[ 7.01801797], [ 0.17717732], [-0.80480472], [-1.78678675], [ 1.23123121], [12.24924918], [10.26726714]])
